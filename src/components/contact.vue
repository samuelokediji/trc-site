        ...
        <div class="col-lg-4">
          <div class="mt-4 pt-4">
            <p class="mt-4">
              ...
              <br />
              <span class="text-muted d-block mt-2">Eaglesworld Close, Balogun Estate, Opposite Farapark, Majek, Lagos</span>
            </p>
            <p class="mt-4">
              <span class="h5">Office Address 2:</span>
              <br />
              <span class="text-muted d-block mt-2">
              Eaglesworld School premises, Balogun Estate.
                <br /> Opposite Farapark, Majek, Lagos
              </span>
            </p>
            <p class="mt-4">
